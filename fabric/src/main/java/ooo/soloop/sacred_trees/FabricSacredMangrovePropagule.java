...
public class FabricSacredMangrovePropagule extends AbstractSacredMangrovePropagule {

    public FabricSacredMangrovePropagule(Block log, Block wood, Block leaves, Properties properties, Type type) {
        super(log, wood, leaves, properties, type);
    }

    public FabricSacredMangrovePropagule(BlockState log, BlockState wood, BlockState leaves, Properties properties, Type type) {
        super(log, wood, leaves, properties, type);
    }
