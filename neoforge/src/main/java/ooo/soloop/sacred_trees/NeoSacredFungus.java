...
public class NeoSacredFungus extends AbstractSacredFungus {

    public NeoSacredFungus(Block log, Block wood, Block leaves, Block lights, Block vines, Block vines2,
                           Properties properties, Type type) {
        super(log, wood, leaves, lights, vines, vines2, properties, type);
    }

    public NeoSacredFungus(BlockState log, BlockState wood, BlockState leaves, BlockState lights,
